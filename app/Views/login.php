      ...
      <form class="space-y-6" action="<?php echo base_url();?>/login" method="POST">
        <div>
          ...
          <div class="mt-1">
            ...
            <div class="mt-2 text-sm text-red-600"><?php if ($validation->showError('email')) { echo $validation->showError('email'); } ?>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-1">
            ...
            <div class="mt-2 text-sm text-red-600"><?php if ($validation->showError('password')) { echo $validation->showError('password'); } ?>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="<?php echo base_url();?>/forgetpassword" class="font-medium text-indigo-600 hover:text-indigo-500">
